...
public class BibleDbProv extends ContentProvider {
    String TAG = "BibleProvider";

    public static String AUTHORITY = "com.jackson_siro.mbible.bibles.BibleDbProv";
    ...
    public boolean onCreate() {
        mTextbook = new BibleDbase(getContext());
        return true;
    }
    ...
    private Cursor getSuggestions(String query) {
      //query = query.toLowerCase();
    	String[] columns = new String[] { BaseColumns._ID, BibleDbase.BIBLE_TITLE,
                BibleDbase.BIBLE_CONTENT,SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID};
    ...
    private Cursor search(String query) {
      //query = query.toLowerCase();
    	String[] columns = new String[] { BaseColumns._ID, BibleDbase.BIBLE_TITLE, BibleDbase.BIBLE_CONTENT};
    ...
    private Cursor getText(Uri uri) {
      ...
      String[] columns = new String[] { BibleDbase.BIBLE_TITLE, BibleDbase.BIBLE_CONTENT};
    ...
    private Cursor refreshShortcut(Uri uri) {
      ...
      String[] columns = new String[] {
          BaseColumns._ID,
          BibleDbase.BIBLE_TITLE,
          BibleDbase.BIBLE_CONTENT,
