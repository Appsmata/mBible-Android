...
public class Settings4 extends Activity {
    public static final String BELIEVERS_BIBLES = "believers_songs";
    public static final String CIA_KUINIRA = "cia_kuinira";
    public static final String MY_OWN_BIBLES = "my_own_songs";
    ...
    public static final String VSB_SETTINGS = "vBIBLE_BOOKs";
    ...
    /* renamed from: com.jackson_siro.mbible.Settings4.1 */
    ...
    /* renamed from: com.jackson_siro.mbible.Settings4.2 */
    ...
    /* renamed from: com.jackson_siro.mbible.Settings4.3 */
    class C01743 implements OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            Settings4.this.getSharedPreferences(Settings4.VSB_SETTINGS, 0).edit().putString(Settings4.BELIEVERS_BIBLES, tuto_choice).commit();
        }
    }

    /* renamed from: com.jackson_siro.mbible.Settings4.4 */
    ...
    /* renamed from: com.jackson_siro.mbible.Settings4.5 */
    ...
    /* renamed from: com.jackson_siro.mbible.Settings4.6 */
    class C01776 implements OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            Settings4.this.getSharedPreferences(Settings4.VSB_SETTINGS, 0).edit().putString(Settings4.MY_OWN_BIBLES, tuto_choice).commit();
        }
    }

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.settings_iv);
        ...
        String believers_songs = settings.getString(BELIEVERS_BIBLES, "0");
        String tenzi_za_rohoni = settings.getString(TENZI_ZA_ROHONI, "0");
        String cia_kuinira = settings.getString(CIA_KUINIRA, "0");
        String my_own_songs = settings.getString(MY_OWN_BIBLES, "0");
