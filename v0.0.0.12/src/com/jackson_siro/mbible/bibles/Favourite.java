...
import com.jackson_siro.mbible.adaptor.SimpleGestureFilter;
import com.jackson_siro.mbible.adaptor.SimpleGestureFilter.SimpleGestureListener;
...
public class Favourite extends ActionBarActivity implements SimpleGestureListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ob_bible);
		ScrollView ScrollScroll = (ScrollView) findViewById(R.id.ScrollSong);
		getLayoutInflater().inflate(R.layout.ob_bible_scroll, ScrollScroll);
